...
import Application.EmployeeManager.EmployeeManagerArray;
...
public class RunArray {
    ...
    private int nCopy = 0;
    EmployeeManagerArray manager = new EmployeeManagerArray();
                    ...
                    do {
                        ...
                        try {
                            if (this.n == 0) {
                                control = false;
                                this.n = sc.nextInt();
                                manager.createArr(this.n);
                                this.nCopy = this.n;

                            } else {
                                this.nCopy = sc.nextInt();
                                this.n += this.nCopy;
                                manager.addArr(this.n);
